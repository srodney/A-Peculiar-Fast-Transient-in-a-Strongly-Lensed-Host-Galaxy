...
%\author{All of Us, In Some Order}
 ...
 \author{S.~A.~Rodney\altaffilmark{\affilref{JHU},\affilref{HubbleFellow},\affilref{USC}}}
 \affilreftxt{JHU}{\JHU}
 \affilreftxt{HubbleFellow}{\HubbleFellow}
 \affilreftxt{USC}{\USC}
 \email{srodney@sc.edu}

\author{I.~Balestra\altaffilmark{\affilref{Munich}}}
\affilreftxt{Munich}{\Munich}

 \author{M.~Brada\v{c}\altaffilmark{\affilref{UCDavis}}}
 \affilreftxt{UCDavis}{\UCDavis}
 
 \author{G.~Brammer\altaffilmark{\affilref{STScI}}}
 \affilreftxt{STScI}{\STScI}

\author{T.~Broadhurst\altaffilmark{\affilref{EHU},\affilref{Basque}}}
\affilreftxt{EHU}{\EHU}
...
\author{G.~Chirivi\altaffilmark{\affilref{MPIA}}}
\affilreftxt{MPIA}{\MPIA}

  \author{J.~M.~Diego\altaffilmark{\affilref{IFCA}}}
  \affilreftxt{IFCA}{\IFCA}
  
\author{A.~V.~Filippenko\altaffilmark{\affilref{Berkeley}}}
\affilreftxt{Berkeley}{\Berkeley}
 
 \author{R.~J.~Foley\altaffilmark{\affilref{IllinoisPhysics},\affilref{IllinoisAstro},\affilref{UCSC}}}
 \affilreftxt{IllinoisPhysics}{\IllinoisPhysics}
 \affilreftxt{IllinoisAstro}{\IllinoisAstro}
 \affilreftxt{UCSC}{\UCSC}

 \author{O.~Graur\altaffilmark{\affilref{NYU},\affilref{AMNH},\affilref{CfA}}}
 \affilreftxt{NYU}{\NYU}
 \affilreftxt{AMNH}{\AMNH}
 \affilreftxt{CfA}{\CfA}

\author{C.~Grillo\altaffilmark{\affilref{DARK}}}
\affilreftxt{DARK}{\DARK}

 \author{S.~Hemmati\altaffilmark{\affilref{CalTech}}}
 \affilreftxt{CalTech}{\CalTech}

 \author{J.~Hjorth\altaffilmark{\affilref{DARK}}}
 \affilreftxt{DARK}{\DARK}

\author{A.~Hoag\altaffilmark{\affilref{UCDavis}}}
\affilreftxt{UCDavis}{\UCDavis}

\author{M.~Jauzac\altaffilmark{\affilref{CEA},\affilref{ICC},\affilref{ACRU}}}
\affilreftxt{CEA}{\CEA}
\affilreftxt{ICC}{\ICC}
\affilreftxt{ACRU}{\ACRU}

\author{S.~W.~Jha\altaffilmark{\affilref{Rutgers}}}
\affilreftxt{Rutgers}{\Rutgers}

\author{R.~Kawamata\altaffilmark{\affilref{TokyoAstro}}}
\affilreftxt{TokyoAstro}{\TokyoAstro}

\author{P.~L.~Kelly\altaffilmark{\affilref{Berkeley}}}
\affilreftxt{Berkeley}{\Berkeley}

\author{C.~McCully\altaffilmark{\affilref{LCOGT},\affilref{UCSB}}}
\affilreftxt{LCOGT}{\LCOGT}
\affilreftxt{UCSB}{\UCSB}
 
\author{B.~Mobasher\altaffilmark{\affilref{UCRiverside}}}
\affilreftxt{UCRiverside}{\UCRiverside}

\author{A.~Molino\altaffilmark{\affilref{SaoPaulo},\affilref{Andalucia}}}
\affilreftxt{SaoPaulo}{\SaoPaulo}
\affilreftxt{Andalucia}{\Andalucia}

\author{M.~Oguri\altaffilmark{\affilref{TokyoRCEU},\affilref{TokyoPhys},\affilref{TokyoIPMU}}}
\affilreftxt{TokyoRCEU}{\TokyoRCEU}
\affilreftxt{TokyoPhys}{\TokyoPhys}
\affilreftxt{TokyoIPMU}{\TokyoIPMU}

 
 \author{A.~G.~Riess\altaffilmark{\affilref{JHU},\affilref{STScI}}}
 \affilreftxt{JHU}{\JHU}
 \affilreftxt{STScI}{\STScI}

\author{J.~Richard\altaffilmark{\affilref{Lyon}}}
\affilreftxt{Lyon}{\Lyon}

 
\author{P.~Rosati\altaffilmark{\affilref{Ferrara}}}
\affilreftxt{Ferrara}{\Ferrara}

\author{K.~B.~Schmidt\altaffilmark{\affilref{UCSB},\affilref{AIP}}}
\affilreftxt{UCSB}{\UCSB}
\affilreftxt{AIP}{\AIP}
 
\author{J.~Selsing\altaffilmark{\affilref{DARK}}}
\affilreftxt{DARK}{\DARK}
 
\author{K.~Sharon\altaffilmark{\affilref{Michigan}}}
\affilreftxt{Michigan}{\Michigan}

\author{L.-G.~Strolger\altaffilmark{\affilref{STScI}}}
\affilreftxt{STScI}{\STScI}

\author{S.-H.~Suyu\altaffilmark{\affilref{MPIA},\affilref{ASIAA},\affilref{Garching}}}
\affilreftxt{MPIA}{\MPIA}
\affilreftxt{ASIAA}{\ASIAA}
\affilreftxt{Garching}{\Garching}

\author{T.~Treu\altaffilmark{\affilref{UCLA},\affilref{Packard}}}
\affilreftxt{UCLA}{\UCLA}
\affilreftxt{Packard}{\Packard}
 
\author{B.~J.~Weiner\altaffilmark{\affilref{Arizona}}}
\affilreftxt{Arizona}{\Arizona}

\author{L.~L.~R.~Williams\altaffilmark{\affilref{Minnesota}}}
\affilreftxt{Minnesota}{\Minnesota}


\author{A.~Zitrin\altaffilmark{\affilref{CalTech},\affilref{BenGurion},\affilref{HubbleFellow}}}
\affilreftxt{CalTech}{\CalTech}
