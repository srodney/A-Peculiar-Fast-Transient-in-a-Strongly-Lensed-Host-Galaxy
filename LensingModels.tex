...
\tablewidth{\linewidth}
  \tablecolumns{6}
\tablecaption{Lens model predictions for time delays and magnifications\label{tab:LensModelPredictions}}
\tablehead{ 
...
\enddata
\tablecomments{Time delays give the predicted delay relative to an appearance in host image 11.2.}
\end{deluxetable}
