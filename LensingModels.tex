...
In Figure~\ref{fig:LineOfSightEffects}, we highlight two galaxies that
appear close to the lines of sight to the \spock transients.

Both the reconstructed position of the $z=0.9397$ galaxy (sys12) and
the foreground $z=0.0557$ galaxy have a projected separation of
approximately 4 arcsec from the \spocktwo transient position.  None of
the lens models used in this analysis have included these galaxies,
except for GlEE-B.  The GLEE-B model is a multi-plane model, adding
these two galaxies as separate lenses.  Since the system 12 galaxy at
$z=0.9397$ is behind the cluster, including this galaxy in the lensing
model not only impacts the magnifications and time delays, but also
results in a shift of the position of the critical curve--as can be
seen in Figure~\ref{fig:CrticialCurves}. A more detailed multi-plane
lensing analysis would be necessary to fully quantify the impact of
these lensing perturbations in the other models.
