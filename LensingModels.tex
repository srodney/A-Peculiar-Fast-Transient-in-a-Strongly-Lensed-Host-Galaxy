...
\tablewidth{\linewidth} \tablecolumns{6} \tablecaption{Lens model
  ...
  \colhead{Model} & \colhead{$\Delta t_{11.1}$} & \colhead{$\Delta
    t_{11.3}$} & \colhead{$\mu_1$} & \colhead{$\mu_2$} &
...
10$\pm$4 & & \\ \enddata \tablecomments{Time delays give the predicted
  delay relative to an appearance in host image 11.2.}
\end{deluxetable}
