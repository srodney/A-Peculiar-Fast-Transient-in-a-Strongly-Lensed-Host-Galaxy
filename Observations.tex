...
\subsection{X-ray Non-detections}\label{Xray}
...
ACS-WFC detectors, respectively. Table \TODO{(add a table with
  photometry)} %~\ref{tab:Photometry} and Figure~\ref{fig:LightCurves}
...
aperture photometry with a 0\farcs3 radius, and also by fitting with
...
position of \spock2.  The total integration time was 4.0 hours for the
