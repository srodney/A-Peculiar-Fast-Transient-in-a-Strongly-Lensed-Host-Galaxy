...
Table~\ref{tab:Photometry} presents photometry of the \spock\ events
from all available HST observations. The flux was measured on
difference images, first using aperture photometry with a 0\farcsec3
...
out using the {\tt PyPhot} software package \citep{Jones:2015}.
