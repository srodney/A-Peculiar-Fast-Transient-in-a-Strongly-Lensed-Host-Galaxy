\subsection{Recurrent Nova Light Curve Comparison}\label{sec:RNLightCurves}
...
\subsection{Recurrent Nova Luminosity and Recurrence Period}\label{sec:RNLuminosityRecurrence}
