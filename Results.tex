...
\enddata \tablecomments{ Each lens model is identified by the name of
  the modeling method (described in Methods~\ref{sec:LensingModels}).
  Time delays give the predicted delay relative to an appearance in
  the NW host image, 11.2. Positive (negative) values indicate the NW
  image is the leading (trailing) image of the pair.  The observed
  time lag between the NW and SE events was
...
August 31, 2014 (MJD=56900, \dataset[ADS/Sa.CXO#obs/16236]{Chandra
  ObsId 16236}), which was coeval with the peak of IR emission from
