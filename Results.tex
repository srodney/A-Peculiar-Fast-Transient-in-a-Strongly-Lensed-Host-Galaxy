...
delays relative to the \spockone\ event, which
...
move a critical curve closer to the position of \spockone\ would
drive the magnification of that event much higher (toward
$\mu_1\sim300$).  That would generally also have the effect of
